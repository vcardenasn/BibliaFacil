...
return [
    ...
    'trivia'    => ['name' => 'Trivia Bíblica',         'emoji' => '🏆', 'desc' => 'Preguntas de personajes, milagros y más.', 'ready' => false],
    'versiculo' => ['name' => 'Completa el Versículo',  'emoji' => '📖', 'desc' => '¿Qué palabra falta en la Biblia?', 'ready' => false],
    'historia'  => ['name' => 'Ordena la Historia',     'emoji' => '🎬', 'desc' => 'Pon las escenas en orden.', 'ready' => false],
    'memory'    => ['name' => 'Memory Bíblico',         'emoji' => '🃏', 'desc' => 'Encuentra todas las parejas.', 'ready' => false],
    'libros'    => ['name' => 'Ordena los Libros',      'emoji' => '📚', 'desc' => '¿Sabes el orden de la Biblia?', 'ready' => false],
